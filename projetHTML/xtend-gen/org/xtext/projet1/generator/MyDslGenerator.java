    ...
    for (final GraphRealisation graph : _ownedGraphRealisation_1) {
      {
        ...
        int _size = CouleurGraph.size();
        boolean _greaterThan = (_size > 1);
        if (_greaterThan) {
          String _ModifCouleur = ModifCouleur;
          ModifCouleur = (_ModifCouleur + ((",marker=dict(color=" + CouleurGraph) + ")"));
        } else {
          int _size_1 = CouleurGraph.size();
          boolean _equals = (_size_1 == 1);
          if (_equals) {
            String _ModifCouleur_1 = ModifCouleur;
            String _get = CouleurGraph.get(0);
            String _plus_9 = (",marker=dict(color=" + _get);
            String _plus_10 = (_plus_9 + ")");
            ModifCouleur = (_ModifCouleur_1 + _plus_10);
          }
        }
        ...
        if (_greaterThan_1) {
          for (final String Ordonnee : NameColumnsOrdonnee) {
            {
              ...
              for (final GraphUpdate update : _ownedGraphUpdate_1) {
                if ((update instanceof UpdateNameLegend)) {
                  ...
                  boolean _equals_1 = Objects.equal(Ordonnee, _plus_12);
                  if (_equals_1) {
          ...
          String _get_1 = NameColumnsOrdonnee.get(0);
          String _plus_11 = (",name=" + _get_1);
          String ModifName = (_plus_11 + "");
          ...
          for (final GraphUpdate update_1 : _ownedGraphUpdate_2) {
            if ((update_1 instanceof UpdateNameLegend)) {
              ...
              boolean _equals_1 = Objects.equal(_get_2, _oldname);
              if (_equals_1) {
                String _newname = ((UpdateNameLegend)update_1).getNewname();
                String _plus_12 = (",name=\'" + _newname);
          ...
          String _fileContent_11 = fileContent;
          fileContent = (_fileContent_11 + (((((((((("trace" + Integer.valueOf(i)) + " = go.") + TypeGraphique) + "(x=Data[") + NameColumnAbscisse) + "], y=Data") + NameColumnsOrdonnee) + ModifName) + ModifCouleur) + ")\n"));
          String _fileContent_12 = fileContent;
          fileContent = (_fileContent_12 + (((((("fig.add_trace(trace" + Integer.valueOf(i)) + ", row=") + Integer.valueOf(rows)) + ", col=") + Integer.valueOf(cols)) + ")\n"));
          int _i = i;
          i = (_i + 1);
          ...
          for (final GraphUpdate update_2 : _ownedGraphUpdate_3) {
            ...
            fileContent = (_fileContent_13 + _translateUpdateAxeName_1);
          }
        }
