...
import org.xtext.projet1.formatting2.MyDslFormatter;
import org.xtext.projet1.generator.MyDslGenerator;
import org.xtext.projet1.parser.antlr.MyDslAntlrTokenFileProvider;
import org.xtext.projet1.parser.antlr.MyDslParser;
import org.xtext.projet1.parser.antlr.internal.InternalMyDslLexer;
import org.xtext.projet1.scoping.MyDslScopeProvider;
import org.xtext.projet1.serializer.MyDslSemanticSequencer;
import org.xtext.projet1.serializer.MyDslSyntacticSequencer;
import org.xtext.projet1.services.MyDslGrammarAccess;
import org.xtext.projet1.validation.MyDslConfigurableIssueCodesProvider;
import org.xtext.projet1.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/projet1/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.projet1.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("phtml");
	}
