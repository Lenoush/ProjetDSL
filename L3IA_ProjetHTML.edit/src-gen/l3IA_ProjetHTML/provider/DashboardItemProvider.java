...
/**
 * This is the item provider adapter for a {@link l3IA_ProjetHTML.Dashboard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DashboardItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Dashboard_name_feature",
								"_UI_Dashboard_type"),
						L3IA_ProjetHTMLPackage.Literals.DASHBOARD__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(L3IA_ProjetHTMLPackage.Literals.DASHBOARD__OWNED_GRAPH_REALISATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(L3IA_ProjetHTMLPackage.Literals.DASHBOARD__OWNED_GRAPH_REALISATION,
				L3IA_ProjetHTMLFactory.eINSTANCE.createGraphRealisation()));
	}
